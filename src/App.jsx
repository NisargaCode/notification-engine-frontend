...
  // ⭐ MODIFIED SECTION: Use isToday, isTomorrow, and advanced formatting ⭐
  let dateString;
  let timeString = format(dueDate, 'h:mm a');
...
    dateString = 'Tomorrow';
  } else {
    dateString = format(dueDate, 'do MMMM, yyyy'); // e.g., 22nd August, 2025
  }
...
    // ⭐ MODIFIED URL ⭐
    let url = `${API_BASE_URL}/api/trainings`;
    if (term) {
...
    try {
        // ⭐ MODIFIED URL ⭐
        const response = await fetch(`${API_BASE_URL}/api/trainings/${trainingId}/send-notification`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        });
